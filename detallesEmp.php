		...
		?>
			<div class="">
				<center>
                    ...
                    <span>Descripcion: <?php echo $f['descripcion'];?></span><br><br><br>
                    <a href="./modificarProd.php?id=<?php  echo $f['id'];?>">Modificar</a>
                    <a href="./borrarProd.php?id=<?php  echo $f['id'];?>">Eliminar</a>
			    </center>
		    </div>
	<?php
		}

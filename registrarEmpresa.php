			...
			<div class="contenedor">
				<nav class="menu" >
					<ul>
						...
						<li><a  href="mEmpresa.php">Lista de Empresas</a></li>
					</ul>
				</nav>
			</div>
   		</header>
				...
				<div id="signupbox" style="margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-info">
						<div class="panel-heading">
							...
							<div style="float:right; font-size: 85%; position: relative; top:-10px"><a id="signinlink" href="loginEmpresa.php">Iniciar Sesi&oacute;n</a></div>
						</div>  
						...
						<div class="panel-body" >
							...
							<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="ruc" class="form-control" name="ruc" placeholder="RUC" value="<?php if(isset($ruc)) echo $ruc; ?>" required>
									</div>
								</div>
								...
								<div>
									...
									<?php
										...
										if(!empty($_POST))
										{
											...
											if(isNull($nombre, $usuario, $password, $con_password, $email,$ruc,$telefono))
											{
											...
											if(count($errors) == 0)
											{
												...
												$registro = registraUsuario($usuario, $pass_hash, $nombre, $email, $activo, $tipo_usuario, $ruc, $telefono);
												
						
												if($registro > 0 )
												{
													echo "hola";
													echo '<div class="alert alert-success"  > <strong>Registro Exitoso!</strong> Ahora podra ingresar  &#128512;</div>';

...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			...
			<div class="row">
				<a href="registrarEmpresa.php" class="btn btn-primary">Nuevo Registro</a>
					...
					<tbody>
						<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><a href="empresa.php?id=<?php echo $row['id']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
